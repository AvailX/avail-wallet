...
const Alert = (properties: AlertProps) => (
  <MuiAlert elevation={6} variant="filled" {...properties} />
);
...
export const ErrorAlert: React.FC<ErrorAlertProperties> = ({
  errorAlert,
  message,
  setErrorAlert,
}) => (
...
export const WarningAlert: React.FC<WarningAlertProperties> = ({
  warningAlert,
  message,
  setWarningAlert,
}) => (
...
export const InfoAlert: React.FC<InfoAlertProperties> = ({
  infoAlert,
  message,
  setInfoAlert,
}) => (
...
export const SuccessAlert: React.FC<SuccessAlertProperties> = ({
  successAlert,
  message,
  setSuccessAlert,
}) => (
