...
import {type Verify, type SignClientTypes} from '@walletconnect/types';
import {Web3Wallet, type IWeb3Wallet, type Web3WalletTypes} from '@walletconnect/web3wallet';
import {buildApprovedNamespaces, getSdkError} from '@walletconnect/utils';
import {type JsonRpcResult, type JsonRpcError, formatJsonRpcError} from '@walletconnect/jsonrpc-utils';
