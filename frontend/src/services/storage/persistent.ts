...
export async function updateUsername(username: string) {
    const res: string = await invoke("update_username", { username: username });
    return res;
}
...
export async function updateBackupFlag(backup_flag: boolean) {
    const res: string = await invoke("update_backup_flag",{backup_flag: backup_flag});
    return res;
}
...
export async function updateNetwork(network: string) {
    const res: string = await invoke("update_network", { network: network });
    return res;
}
...
export async function updateLanguage(language: Languages){
    const res: string = await invoke("update_language", { language: language });
    return res;
}