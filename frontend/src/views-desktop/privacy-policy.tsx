...
const Rights = () => {
    return (<mui.TableContainer component={mui.Paper} sx={{ alignSelf: 'center', mt: "2%" }}>
...
function PrivacyPolicy() {
    return (
        <Layout>
            ...
            <BodyText sx={{ color: '#fff', mt: '2%'}}>This Privacy Notice (the “Notice”) Applies to the Processing of Personal Data to the use of the website <a style={{cursor:'pointer'}} onClick={() => { open_url("https://avail.global") }}>www.avail.global</a> and the application Avail. </BodyText>
            ...
            <BodyText sx={{ color: '#fff', mt: '2%' }}>
                Access to this website and application implies the users’ full and unreserved acceptance of this Notice, as well as Our general terms and conditions of business and the Cookie Notice, available <a style={{cursor:'pointer'}} onClick={() => { open_url("https://avail.global/cookie-notice") }}>here</a>. The user acknowledges that they have read and understood the terms within this Notice and agree to the Processing of their Personal Data.
            </BodyText>
            <BodyText sx={{ color: '#fff', mt: '2%' }}>
                This Notice is valid for all pages hosted on the website, and all features of the application. It is not valid for the pages hosted by third parties to which We may refer and whose privacy notices may differ. We therefore, cannot be held responsible for any Personal Data Processed on these websites by other third parties. This Notice also applies to other websites that We may operate, including our company pages on all the socials linked <a  style={{cursor:'pointer'}} onClick={() => { open_url("https://linktr.ee/avail.global") }}>here</a>.
            </BodyText>
            <BodyText sx={{ color: '#fff', mt: '2%' }}>
            ...
            <BodyText sx={{ color: '#fff', mt: '2%' }}>
                You may also complain to the supervisory authority, the Information and Data Protection Commissioner (“IDPC”) whose website is available <a  style={{cursor:'pointer'}} onClick={() => open_url("https://idpc.org.mt/")}>here</a>.
            </BodyText>
            </mui.Box>
        </Layout>
    )
