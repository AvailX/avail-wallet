...
const MessageBar = () => {
    ...
    return (
        <mui.Box sx={{
            ...
            {!isTyping && (
            <mui.Box sx={{ width: '90%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', gap: '5%' }}>
                <mui.Button
                    variant="contained"
                    autoCapitalize="false"
                    sx={{ backgroundColor: '#00FFAA', width: '25%', borderRadius: '30px', height: '40px', display: 'flex', justifyContent: 'center', alignContent: 'center', alignItems: 'center', textTransform: 'none' }}
                    onClick={() => { }}
                >
            ...
            <mui.OutlinedInput
                ...
                endAdornment={
                    <mui.InputAdornment position="end">
                        ...
                        <mui.IconButton edge="end"  onMouseDown={()=>{setMessage(''); handleSendMessage();}} >
