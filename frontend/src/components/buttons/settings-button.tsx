...
export default function STButton({ text,onClick }: CtaButtonProps) {
  ...
  return <SettingButton onClick={onClick} disabled={isDisabled(text)} sx={{ml:'2%',mt:'2%',bgcolor:(text === "Delete Account")?'#D21C1C':'#00FFAA', '&:hover':{bgcolor:(text === "Delete Account")?'#D21C1C':'#00FFAA'},'&:focus':{bgcolor:(text === "Delete Account")?'#D21C1C':'#00FFAA',}}}>
