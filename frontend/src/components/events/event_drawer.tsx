...
//types
import { AvailEvent, AvailEventStatus } from '../../services/wallet-connect/WCTypes';
import { EventType, EventStatus } from '../../services/wallet-connect/WCTypes';
import { SubMainTitleText, SubtitleText, BodyText, BodyText500 } from '../typography/typography';
    ...
    return (
      ...
      >
        <Box sx={{ overflowY: 'auto', height: '100%', display: 'flex', flexDirection: 'column' }}> {/* Allows scrolling only within the drawer */}
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', width: '80%', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
        ...
        <Box sx={{ overflowY: 'auto', height: '100%', display: 'flex', flexDirection: 'column' }}> {/* Allows scrolling only within the drawer */}
          ...
          <Box sx={{ padding: 2, display: 'flex', flexDirection: 'column', width: '80%', alignSelf: 'center' }}>
            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', width: '30%', justifyContent: 'flex-end' }}>
