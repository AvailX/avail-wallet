...
import { TokenProps, token } from "../../types/transfer_props/tokens";
        ...
        <mui.Box sx={{width:'50%'}}>
            <mui.FormControl fullWidth   sx={{outline:'none',border:0 }}>
                ...
                <mui.Select
                    ...
                    sx={{outline:'none',border:0,height:'50px', "&.MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline":
                    {
                      border: 'none',
                    },
                ...
                {tokens.map((token:token,i) => {
                    return <mui.MenuItem value={token.symbol} key={i} sx={{bgcolor:'#3E3E3E'}}>
                        <mui.Box sx={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',ml:'10%',mt:'2%'}}>
