...
const SettingsComponent:React.FC<SettingsProps> = ({ onTransferFromToggle,onTransferToToggle, onFeeToggle }) => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column',width:'85%',alignSelf:'center',ml:'2%',mt:'2%' }}>
      <ToggleRow
