...
//typography
import {  SmallText, SubMainTitleText, Title2Text ,SubtitleText, TitleText,BodyText500,BodyText} from '../typography/typography';
...
//alerts
import { ErrorAlert, WarningAlert, InfoAlert, SuccessAlert } from '../snackbars/alerts';
...
const BackupDialog: React.FC<BackupDrawerProps> = ({ open, onClose}) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{width:'85%',display:'flex',flexDirection:'row',alignSelf:'center',justifyContent:'center'}}>
      ...
      <BodyText sx={{width:'80%',alignSelf:'center',textAlign:'center',color:'#fff',mt:'2%'}}>
