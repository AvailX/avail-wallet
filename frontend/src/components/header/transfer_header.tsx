...
const TransferHeader = () => {
    ...
    return(
              <mui.Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', alignItems: 'center', width: '95%'}}>
              <mui.Box className="hex2" onClick={()=>navigate('/account')}>
