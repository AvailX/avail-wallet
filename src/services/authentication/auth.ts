...
export async function session_and_local_auth(
...
export function get_hash(
  ...
  invoke<CreateSessionResponse>("request_hash")
    .then((res) => {
...
export function get_signature(
  ...
  invoke<VerifySessionRequest>("sign_hash", { request, password })
    .then((res) => {
...
export function session(
  ...
  invoke<string>("get_session_only", { request })
    .then((session_id) => {
