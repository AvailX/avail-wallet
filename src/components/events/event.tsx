...
import {
	EventType, AvailEvent, EventStatus, AvailEventStatus,
...
const EventIcon: React.FC<{type: EventType}> = ({type}): JSX.Element => {
	switch (type) {
		case EventType.Send: {
			return (
				<mui.Box sx={{
					width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #ccc', bgcolor: 'transparent',
				}}>
		...
		case EventType.Receive: {
			return (
				<mui.Box sx={{
					width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #00FFAA', bgcolor: 'transparent',
				}}>
