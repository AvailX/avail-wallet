...
import { getViewingKey } from "../../../../src-desktop/services/storage/keys";
import {
  ErrorAlert,
  SuccessAlert,
...
const ViewKeyDialog: React.FC<VkDialogProperties> = ({
  isOpen,
  onRequestClose,
  setViewKey,
}) => {
      ...
      >
        ...
        <mui.DialogContent>
          <mui.DialogContentText sx={{ color: "#a3a3a3" }}>
            This action will decrypt your Viewing Key and display it on the
