...
import { getPrivateKey } from "../../../../src-desktop/services/storage/keys";
import {
  ErrorAlert,
  SuccessAlert,
...
const PrivateKeyDialog: React.FC<PkDialogProperties> = ({
  isOpen,
  onRequestClose,
  setPrivateKey,
}) => {
      ...
      >
        ...
        <mui.DialogContent>
          <mui.DialogContentText sx={{ color: "#a3a3a3" }}>
            This action will decrypt your Private Key and display it on the
