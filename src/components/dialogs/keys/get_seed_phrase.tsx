...
import { getSeedPhrase } from "../../../../src-desktop/services/storage/keys";
import {
  ErrorAlert,
  SuccessAlert,
...
const SeedPhraseDialog: React.FC<SPDialogProperties> = ({
  isOpen,
  onRequestClose,
  setSeedPhrase,
}) => {
  ...
  return (
    <>
      ...
      >
        <mui.DialogTitle>
          Do you want to get your Secret Phrase ?
        </mui.DialogTitle>
        <mui.DialogContent>
          <mui.DialogContentText sx={{ color: "#a3a3a3" }}>
            This action will decrypt your Secret Phrase and display it on the
            screen. Enter your password to continue.
        ...
        <mui.DialogActions>
          <mui.Button onClick={onRequestClose} sx={buttonStyle}>
            Cancel
          </mui.Button>
          <mui.Button onClick={handleConfirmClick} sx={buttonStyle}>
            Confirm
          </mui.Button>
        </mui.DialogActions>
      </mui.Dialog>
