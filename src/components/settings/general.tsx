...
const GeneralSettings: React.FC<{
	...
	return (
		<mui.Box sx={{padding: 2}}>
			...
			<UsernameDialog isOpen={UsernameDialogOpen} onRequestClose={() => {
				setUsernameDialogOpen(false);
			}} username={username} originalUsername={originalUsername}/>
			<mui.TextField
				...
				InputProps={{
					endAdornment: username === originalUsername ? null : (
			...
			<mui.FormControl fullWidth margin='normal'>
				...
				<mui.Select
					...
					sx={{
						backgroundColor: '#2c2c2c', '.MuiOutlinedInput-root': {color: '#fff'}, '.MuiSelect-icon': {color: '#aaa'}, color: '#fff',
					}}
				>
