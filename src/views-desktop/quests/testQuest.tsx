...
// Services
import {createCampaign, createQuest, isQuestCompleted} from '../../services/quests/quests';
...
const TestQaaS: React.FC = () => {
    ...
    const handleAddField = () => {
        setFields([...fields, {title:'', description:'', transaction:false, program_id:'', function_id:'', dapp_url:'', points:'' }]);
    };
	...
	return (
		<Layout>
            ...
            <mui.Box marginLeft='10%'>
                ...
                <form style={{ backgroundColor: 'white' }} onSubmit={handleCreateCampaign}>
            ...
            <mui.Box marginLeft='10%'>
                ...
                <form style={{ backgroundColor: 'white' }} onSubmit={handleCreateQuests}>
                    <mui.TextField label='Title' />
                ...
                {fields.map((field, index) => (
                    <div key={index}>
                        ...
                        <mui.TextField
                            ...
                            onChange={(e) => handleFieldChange(index, 'transaction', e.target.value)}
                        />
                        <mui.TextField
                            label='Program ID'
                            value={field.program_id}
                            onChange={(e) => handleFieldChange(index, 'program_id', e.target.value)}
                        />
                        <mui.TextField
                            label='Function ID'
                            value={field.function_id}
                            onChange={(e) => handleFieldChange(index, 'function_id', e.target.value)}
                        />
                        <mui.TextField
                            label='Dapp URL'
                            value={field.dapp_url}
                            onChange={(e) => handleFieldChange(index, 'dapp_url', e.target.value)}
                        />
                        <mui.TextField
                            label='Points'
                            value={field.points}
                            onChange={(e) => handleFieldChange(index, 'points', e.target.value)}
                        />
                ...
                <h4>Reward Mechanism</h4>
                    ...
                    <mui.TextField label='Expires On' type='date' InputLabelProps={{shrink: true}} />
