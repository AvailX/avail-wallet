...
const Import = () => {
  ...
  const [isSecureAccountVisible, setIsSecureAccountVisible] =
      ...
      >
        <div>
          <mui.Alert severity="info">
            ...
            This will create an Avail Wallet from the private key you're
            importing. The wallet will scan the entire blockchain for your
