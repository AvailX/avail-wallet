...
import { getRecentAvailEventsSuccinct } from "../../src-desktop/services/events/get_events";
...
// Create the context
const RecentEventsContext = createContext<RecentEventsContextState | undefined>(
  undefined
);
...
export const useRecentEvents = () => {
  ...
  if (!context) {
    throw new Error(
      "useRecentEvents must be used within a RecentEventsProvider"
    );
  }
...
export const RecentEventsProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
