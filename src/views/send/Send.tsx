...
import {
  ...
  get_address,
  getUsername,
} from "../../../src-desktop/services/storage/persistent";

import {
  TransferRequest,
  TransferType,
} from "../../../src-desktop/types/transfer_props/tokens";
import { transfer } from "../../../src-desktop/services/transfer/transfers";

import { getTokenBalance } from "../../../src-desktop/services/states/utils";
...
import { AvailError } from "../../../src-desktop/types/errors";
...
import TransferDialog from "../../../src-desktop/components/dialogs/transfer";
import TransferInProgressDialog from "../../../src-desktop/components/dialogs/transfer_in_progress";

import aleo from "../../../src-desktop/assets/icons/tokens/aleo.svg";
